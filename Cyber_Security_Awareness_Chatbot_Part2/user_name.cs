...
{//start of namespace
    ...
    {//start of class
        ...
        {//start of
            ...
            //cto check if the filename exists or not , then auto create
            if (!File.Exists(filename))
            {
                //auto create the file using the AppendAllText() function
            ...
            {//start of else
                ...
                error_method("Lumina ", "Hey " + name + " welcome back, how can i help you today", chats);
        ...
        {//star of error mehtod
            ...
            if (name.ToLower().Contains("lumina") || name.ToLower().Contains("chat"))
            {// Light blue
            ...
            Brush nameColor = (name.ToLower().Contains("lumina") || name.ToLower().Contains("chat")) ?
                              Brushes.Black : Brushes.DarkGoldenrod;

            Brush messageColor = Brushes.DarkGoldenrod;
